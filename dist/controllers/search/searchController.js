...
exports.saveSearchResults = exports.addStatistics = exports.cleanEbaySearchResults = exports.postEbaySearch = exports.saveSearch = void 0;
...
exports.saveSearch = (0, express_async_handler_1.default)(async (req, res, next) => {
    ...
    if (((_a = req.session) === null || _a === void 0 ? void 0 : _a.userAccount) == null) {
        res.status(400);
...
exports.postEbaySearch = (0, express_async_handler_1.default)(async (req, res, next) => {
    if (req.search === undefined) {
        res.status(400);
        throw new Error("No search provided");
    }
    const OPERATION_NAME = "findItemsAdvanced";
    const SECURITY_APPNAME = config_1.default.ebay.appidProd;
...
exports.cleanEbaySearchResults = (0, express_async_handler_1.default)(async (req, res, next) => {
